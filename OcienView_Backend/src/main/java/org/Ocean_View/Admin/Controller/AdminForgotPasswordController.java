...
import org.Ocean_View.Admin.Services.Implementation.PasswordServiceImpl;
...
public class AdminForgotPasswordController extends HttpServlet
{
    ...
    {
        this.emailService = new PasswordServiceImpl();
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try
        {
            ...
            String passwordResetLink = "http://localhost:8080" + req.getContextPath() + "/Admin/ResetPassword.html";

            emailService.sendPasswordResetEmail(normalizedEmail, passwordResetLink);

            // Success message
            out.println("<script>alert('Password reset link has been sent to your email.'); window.location.href='/Admin/Signing.jsp';</script>");
