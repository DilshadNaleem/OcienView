...
public class AdminEditProfileServlet extends HttpServlet
{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (session == null || session.getAttribute("email") == null) {
            ...
            response.sendRedirect(request.getContextPath() + "/Admin/Signing.jsp");
            return;
        }
        ...
        // Get profile details
        Map<String, EditProfileRequest> profileDetails = adminAuthService.getProfile(session);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Update profile
        String result = adminAuthService.updateProfile(profileRequest, session);
