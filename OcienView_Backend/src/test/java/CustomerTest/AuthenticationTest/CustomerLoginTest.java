...
import org.Ocean_View.Customer.Controller.CustomerLoginServlet;
...
public class CustomerLoginTest {
    ...
    void setUp() throws Exception {
        ...
        // Crucial: Set method to POST and setup Writer
    ...
    void testLoginSuccess() throws Exception {
        ...
        when(customerAuthService.loginCustomer(any(LoginRequest.class), eq(session)))
        ...
        assertTrue(output.contains("/Customer/Dashboard"), "Should redirect to Dashboard");
    }
    ...
    void testEmptyFields() throws Exception {
        ...
        verify(customerAuthService, never()).loginCustomer(any(), any());
    }
}