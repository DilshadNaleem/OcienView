...
import org.Ocean_View.Admin.Controller.AdminRegisterServlet;
import org.Ocean_View.Admin.Controller.AdminRegistrationController;
...
public class AdminRegisterTest
{
    ...
    @Mock
    private AdminRegistrationController mockController;
    ...
    void testRegisterSuccess() throws Exception {
        ...
        when(mockController.registerAdmin(anyString(), anyString(), anyString(), anyString(), anyString(), anyString()))
        ...
        assertTrue(output.contains("/Admin/OTPVerification.jsp"));
    ...
    void testEmailAlreadyExists() throws Exception {
        ...
        when(mockController.registerAdmin(any(), any(), any(), any(), any(), any()))
