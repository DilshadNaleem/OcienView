 ...
 * Generated at: 2026-02-04 19:09:03 UTC
...
public final class RoomCategory_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if (room.getFine() != null && !room.getFine().isEmpty()) { 
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("       let unavailableDates = [];\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("           checkInInput.min = today;\r\n");
      out.write("           checkOutInput.min = today;\r\n");
      ...
      out.write("/Customer/GetBookedDates?roomId=${encodeURIComponent(roomId)}`);\r\n");
      out.write("               unavailableDates = await response.json();\r\n");
      out.write("               console.log(\"Booked dates for this room:\", unavailableDates);\r\n");
      out.write("\r\n");
      out.write("               // Initialize Flatpickr with disabled dates\r\n");
      ...
      out.write("          const checkOutInput = document.getElementById('checkOut');\r\n");
      out.write("\r\n");
      out.write("          // Prepare disabled date ranges from your database\r\n");
      out.write("          const disabledRanges = unavailableDates.map(range => ({\r\n");
      out.write("              from: range.checkIn,\r\n");
      out.write("              to: range.checkOut\r\n");
      out.write("          }));\r\n");
      out.write("\r\n");
      out.write("          // Initialize check-in date picker\r\n");
      out.write("          checkInPicker = flatpickr(checkInInput, {\r\n");
      out.write("              minDate: \"today\",\r\n");
      out.write("              dateFormat: \"Y-m-d\",\r\n");
      out.write("              disable: disabledRanges,\r\n");
      out.write("              onChange: function(selectedDates, dateStr) {\r\n");
      out.write("                  if (selectedDates.length > 0) {\r\n");
      out.write("                      // 1. Set the minimum check-out date to the day after check-in\r\n");
      out.write("                      const nextDay = new Date(selectedDates[0]);\r\n");
      out.write("                      nextDay.setDate(nextDay.getDate() + 1);\r\n");
      out.write("\r\n");
      out.write("                      checkOutPicker.set('minDate', nextDay);\r\n");
      out.write("\r\n");
      out.write("                      // 2. Clear the check-out value to force a new selection\r\n");
      out.write("                      checkOutPicker.clear();\r\n");
      out.write("                      resetTotals();\r\n");
      out.write("\r\n");
      out.write("                      // 3. Open the check-out picker automatically for better UX\r\n");
      out.write("                      setTimeout(() => checkOutPicker.open(), 100);\r\n");
      out.write("                  }\r\n");
      out.write("              }\r\n");
      out.write("          });\r\n");
      out.write("\r\n");
      out.write("          // Initialize check-out date picker\r\n");
      out.write("          checkOutPicker = flatpickr(checkOutInput, {\r\n");
      out.write("              // Initially, check-out cannot be before tomorrow\r\n");
      out.write("              minDate: new Date().fp_incr(1),\r\n");
      out.write("              dateFormat: \"Y-m-d\",\r\n");
      out.write("              disable: disabledRanges,\r\n");
      out.write("              onChange: function(selectedDates, dateStr) {\r\n");
      ...
      out.write("          const checkInVal = document.getElementById('checkIn').value;\r\n");
      out.write("          const checkOutVal = document.getElementById('checkOut').value;\r\n");
