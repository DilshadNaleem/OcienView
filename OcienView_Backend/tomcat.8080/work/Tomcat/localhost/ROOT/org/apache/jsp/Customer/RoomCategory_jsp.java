 ...
 * Generated at: 2026-02-03 17:26:39 UTC
...
public final class RoomCategory_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if (room.getFine() != null && !room.getFine().isEmpty()) { 
      ...
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        function openBookingModal(roomId, price) {\r\n");
      ...
      out.write("\r\n");
      out.write("            checkInInput.setAttribute('min', today);\r\n");
      out.write("            checkOutInput.setAttribute('min', today);\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("            // Set min date for checkout\r\n");
      out.write("            if (checkInVal) {\r\n");
      out.write("                document.getElementById('checkOut').setAttribute('min', checkInVal);\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            if (checkInVal && checkOutVal) {\r\n");
      out.write("                const checkIn = new Date(checkInVal);\r\n");
      out.write("                const checkOut = new Date(checkOutVal);\r\n");
      out.write("\r\n");
      out.write("                if (checkOut > checkIn) {\r\n");
      out.write("                    const diffTime = Math.abs(checkOut - checkIn);\r\n");
      out.write("                    const diffDays = Math.ceil(diffTime / (1000 * 60 * 60 * 24));\r\n");
      out.write("                    const finalPrice = (diffDays * pricePerNight).toFixed(2);\r\n");
      out.write("\r\n");
      out.write("                    // UPDATE: Using .value instead of .innerText\r\n");
      out.write("                    document.getElementById('displayDays').value = diffDays;\r\n");
      out.write("                    document.getElementById('displayTotal').value = finalPrice;\r\n");
      out.write("                } else {\r\n");
      ...
      out.write("            <form id=\"bookingForm\" action=\"ProcessBookingServlet\" method=\"POST\">\r\n");
